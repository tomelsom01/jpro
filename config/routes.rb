Rails.application.routes.draw do
  ...
  get '/howtocontrolcollapse', to: 'howtocontrolcollapse#index'
  get '/global_villages', to: 'global_villages#index'
  get '/spring', to: 'spring#index'
  get '/israeltheschnitzel', to: 'israeltheschnitzel#index'
  get '/explainingindia', to: 'explainingindia#index'
  get '/inlabour', to: 'inlabour#index'
  get '/softzlotys', to: 'softzlotys#index'
  get '/gardenofsiberia', to: 'gardenofsiberias#index'
